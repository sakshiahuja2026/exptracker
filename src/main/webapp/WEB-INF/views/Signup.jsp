...
<div class="signup-form">
    <s:form action="saveuser" method="post" modelAttribute="user">
        ...
        <div class="form-group">
			<div class="row">
				<div class="col">
				FirstName: <s:input  class="form-control" path="firstName" />
		<s:errors path="firstName"></s:errors><br><br>
				</div>
				<div class="col">LastName: <s:input  class="form-control" path="lastName" />
		<s:errors path="lastName"></s:errors><br><br>	</div>
			</div>        	
        </div>
        <div class="form-group">
        	Email : <s:input  class="form-control" path="email" />
		<s:errors path="email"></s:errors><br><br>
        </div>
		<div class="form-group">
           Password :<s:password class="form-control" path="password" />
